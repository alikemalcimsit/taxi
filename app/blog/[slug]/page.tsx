// app/blog/[slug]/page.tsx  (veya proje yapına göre uyarlayın)
...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    ...
    openGraph: {
      ...
      description: post.excerpt,
      type: "article",
      url: `https://example.com/blog/${post.slug}`, // sitenizin domainiyle değiştirin
